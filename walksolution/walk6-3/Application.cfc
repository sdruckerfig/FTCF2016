<cfcomponent output="false">
	...
	<cfset this.name = "ProposalManager63Solution">
	...
	<cffunction name="onApplicationStart">
		...
		<cfset application.basehref = "/ftcf2016/walksolution/walk6-3/">
		<cfset application.cfcpath = "ftcf2016.walksolution.walk6-3.components.">
